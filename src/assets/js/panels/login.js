...
class Login {
    ...
    async getCrack() {
        console.log('Iniciando el login no premium...');
        let popupLogin = new popup();
        ...
        connectOffline.addEventListener('click', async () => {
            if (emailOffline.value.length < 3) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'El usuario tiene que contener como minimo 3 caracteres.',
                    options: true
                });
                return;
            }
            ...
            if (emailOffline.value.match(/ /g)) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'El usuario no puede contener espacios.',
                    options: true
                });
                return;
            }
    ...
    async getAZauth() {
        ...
        AZauthConnectBTN.addEventListener('click', async () => {
            ...
            if (AZauthEmail.value == '' || AZauthPassword.value == '') {
                PopupLogin.openPopup({
                    title: 'Error',
                    content: 'El usuario y la contraseña son requeridos.',
                    options: true
                });
                return;
            }
